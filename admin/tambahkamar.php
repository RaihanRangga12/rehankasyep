<?php
    ...
    echo '<script>window.location="/reservasirehan/index.php"</script>';
    exit();
    } 
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="images/fotoadmin.png" alt="Logo"></a>
                <a class="navbar-brand hidden"><img src="images/1647500438997.png" alt="Logo"></a>
            </div>
       ...
       <!--  -->
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis" class="form-control" placeholder="jenis kamar" id="nama" required="required" autocomplete="off">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="des">Jumlah Kamar</label>
                        <input type="text" name="jumlah" class="form-control" placeholder="jumlah" id="des" required="required" autocomplete="off">
                    </div>
                </div>
                    </div>
                <div class="row">
