    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="images/logo1.png" alt="Logo"></a>
                <a class="navbar-brand hidden"><img src="images/logo1.png" alt="Logo"></a>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="kamarproses.php" method="post" novalidate="novalidate">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            <label for="cc-exp" class="control-label mb-1">Jumlah</label>
                                                            <input type="number" name="jumlah" class="form-control" placeholder="jumlah kamar">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
