...
<body>
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="dashboard.php">
                                    <img src="img/logo1.png" width="85px" alt="">
                                </a>
                            </div>
                        </div>
    ...
    <div class="bradcam_area breadcam_bg_1">
        <h3>Grand Synthesia leviathan</h3>
    </div>
    <!-- bradcam_area_end -->
    <br>
    <br>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_offers">
                        <div class="about_thumb">
                            <a href="images/<?php echo $d['gambar'] ?>" width="100px"><img src="/reservasirehan/gambar/<?php echo $d['gambar'] ?>" width="100px" alt=""></a>
                        </div>
                    <div class="room-desc">
                        <div class="room-name">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text" > Batujajar Barat <br>
                                    Bandung Barat</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text" >+62 0822 136 766 <br>
                                    raihanrangga122@gmail.com</p>
                        </div>
                    </div>
